(() => {
  ...
  // All product details use one canonical route. This prevents the three
  // legacy model pages from loading different script stacks.
  const pageFor = (id) => `model.html?model=${encodeURIComponent(id)}`;
