...
export const config = Object.freeze({
  ...
  telegramBotUsername: username(process.env.TELEGRAM_BOT_USERNAME || "Mdr_dronsbot"),
  telegramWebhookSecret: process.env.TELEGRAM_WEBHOOK_SECRET || "",
  telegramAdminUsername: username(process.env.TELEGRAM_ADMIN_USERNAME || "assapproccky"),
  telegramAdminDisplayName: process.env.TELEGRAM_ADMIN_DISPLAY_NAME || "2Much4U nnga",
  autoSetupTelegramWebhook: boolean(process.env.AUTO_SETUP_TELEGRAM_WEBHOOK, process.env.NODE_ENV === "production"),
